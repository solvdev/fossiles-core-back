  ...
  --
  -- EXCLUIDAS (no se cierran): OPL-1175, OPL-1179, OPL-1180, OPL-1181
  --
  -- Sin filtro de fecha: cierra todas las OPL abiertas salvo las exclusiones.
  ...
  --   (verificación: pendientes solo pueden ser las 4 exclusiones)
  -- =====================================================================
  ...
  --
  -- Exclusión (número de OPL, con o sin ceros a la izquierda):
  ...
  -- =====================================================================
  -- B) UPDATES — solo OPL (excepto 1175 / 1179 / 1180 / 1181)
  -- =====================================================================
  ...
  -- C) VERIFICACIÓN
  -- =====================================================================
  -- production_order pendientes: solo deben quedar las exclusiones (si siguen abiertas).
